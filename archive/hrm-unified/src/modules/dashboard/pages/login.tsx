    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-1">{t('dash_login_title')}</p>
        </div>

        <div className="bg-card border border-border rounded-xl p-8 shadow-xl">
          <h2 className="text-xl font-semibold text-foreground mb-6">{t('dash_login_sign_in')}</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-1">{t('dash_login_email')}</label>
              <input
                type="email"
                value={email}
            ...
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-1">{t('dash_login_password')}</label>
              <input
                type="password"
                value={password}
            ...
            >
              {loading ? t('dash_login_signing_in') : t('dash_login_sign_in_btn')}
            </button>
          </form>

          <div className="mt-4 p-3 bg-muted rounded-lg">
            <p className="text-xs text-muted-foreground font-medium mb-1">{t('dash_login_demo_creds')}</p>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          {t('dash_login_created_by')} <span className="text-primary">yasserious.com</span>
        </p>
      </div>
    </div>
  );
