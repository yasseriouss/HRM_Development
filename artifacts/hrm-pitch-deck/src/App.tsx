...
function Controls() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 flex gap-2 p-2 bg-black/50 backdrop-blur-md border border-white/10 rounded-lg opacity-20 hover:opacity-100 transition-opacity">
      <button
        onClick={() => setLang(lang === "en" ? "ar" : "en")}
        className="px-2 py-1 text-xs font-bold text-white border border-white/20 rounded hover:bg-white/10 transition-colors uppercase"
      >
        {lang === "en" ? "AR" : "EN"}
      </button>
      <button
