...
export const DEPARTMENTS: Department[] = [
  { id: 'UPH', code: 'UPH', name: 'Upholstery', manager: 'محمد عبدالله', email: 'upholstery@ebdaa.sa', employeeCount: 22, description: 'Furniture upholstery and fabric work' },
  { id: 'PNT', code: 'PNT', name: 'Painting', manager: 'أحمد الشمري', email: 'painting@ebdaa.sa', employeeCount: 18, description: 'Wood painting and finishing' },
  { id: 'NWD', code: 'NWD', name: 'Natural Wood', manager: 'خالد المطيري', email: 'naturalwood@ebdaa.sa', employeeCount: 16, description: 'Natural wood processing and carpentry' },
  { id: 'ASM', code: 'ASM', name: 'Assembly', manager: 'فهد الدوسري', email: 'assembly@ebdaa.sa', employeeCount: 20, description: 'Furniture assembly and installation' },
  { id: 'CUT', code: 'CUT', name: 'Cutting', manager: 'سعد العتيبي', email: 'cutting@ebdaa.sa', employeeCount: 12, description: 'Precision cutting and sawing' },
  { id: 'QC', code: 'QC', name: 'Quality Control', manager: 'عمر الزهراني', email: 'qc@ebdaa.sa', employeeCount: 10, description: 'Quality inspection and control' },
  { id: 'LOG', code: 'LOG', name: 'Logistics', manager: 'بندر الغامدي', email: 'logistics@ebdaa.sa', employeeCount: 14, description: 'Warehouse, shipping, and logistics' },
  { id: 'MNT', code: 'MNT', name: 'Maintenance', manager: 'نواف الحربي', email: 'maintenance@ebdaa.sa', employeeCount: 8, description: 'Machine and facility maintenance' },
  { id: 'ADM', code: 'ADM', name: 'Administration', manager: 'ريم السبيعي', email: 'admin@ebdaa.sa', employeeCount: 26, description: 'HR, finance, and administration' },
];

export const EMPLOYEES: Employee[] = [
  // Upholstery (22 employees)
  { id: 'E001', code: 'UPH-001', fullName: 'Ahmed Al-Rashidi', departmentId: 'UPH', jobTitle: 'Senior Upholsterer', joinedDate: '2018-03-15', currentClass: 'A', email: 'ahmed.rashidi@ebdaa.sa' },
  { id: 'E002', code: 'UPH-002', fullName: 'Mohammed Saleh', departmentId: 'UPH', jobTitle: 'Upholsterer', joinedDate: '2019-07-01', currentClass: 'A', email: 'mohammed.saleh@ebdaa.sa' },
  { id: 'E003', code: 'UPH-003', fullName: 'Abdullah Nasser', departmentId: 'UPH', jobTitle: 'Upholsterer', joinedDate: '2020-01-10', currentClass: 'B', email: 'abdullah.nasser@ebdaa.sa' },
  { id: 'E004', code: 'UPH-004', fullName: 'Ibrahim Al-Anazi', departmentId: 'UPH', jobTitle: 'Junior Upholsterer', joinedDate: '2021-05-20', currentClass: 'B', email: 'ibrahim.anazi@ebdaa.sa' },
  { id: 'E005', code: 'UPH-005', fullName: 'Khalid Al-Shehri', departmentId: 'UPH', jobTitle: 'Upholsterer', joinedDate: '2019-11-03', currentClass: 'A', email: 'khalid.shehri@ebdaa.sa' },
  { id: 'E006', code: 'UPH-006', fullName: 'Omar Farouk', departmentId: 'UPH', jobTitle: 'Fabric Cutter', joinedDate: '2022-02-14', currentClass: 'C', email: 'omar.farouk@ebdaa.sa' },
  { id: 'E007', code: 'UPH-007', fullName: 'Faisal Al-Mutairi', departmentId: 'UPH', jobTitle: 'Upholsterer', joinedDate: '2018-09-25', currentClass: 'A', email: 'faisal.mutairi@ebdaa.sa' },
  { id: 'E008', code: 'UPH-008', fullName: 'Sultan Al-Bishi', departmentId: 'UPH', jobTitle: 'Junior Upholsterer', joinedDate: '2023-01-08', currentClass: 'C', email: 'sultan.bishi@ebdaa.sa' },
  // Painting (18 employees)
  { id: 'E009', code: 'PNT-001', fullName: 'Nawaf Al-Harbi', departmentId: 'PNT', jobTitle: 'Senior Painter', joinedDate: '2017-06-12', currentClass: 'A', email: 'nawaf.harbi@ebdaa.sa' },
  { id: 'E010', code: 'PNT-002', fullName: 'Saad Al-Otaibi', departmentId: 'PNT', jobTitle: 'Painter', joinedDate: '2019-03-22', currentClass: 'B', email: 'saad.otaibi@ebdaa.sa' },
  { id: 'E011', code: 'PNT-003', fullName: 'Bandar Al-Ghamdi', departmentId: 'PNT', jobTitle: 'Painter', joinedDate: '2020-08-17', currentClass: 'B', email: 'bandar.ghamdi@ebdaa.sa' },
  { id: 'E012', code: 'PNT-004', fullName: 'Rashed Al-Dosari', departmentId: 'PNT', jobTitle: 'Junior Painter', joinedDate: '2022-04-05', currentClass: 'C', email: 'rashed.dosari@ebdaa.sa' },
  { id: 'E013', code: 'PNT-005', fullName: 'Turki Al-Zahrani', departmentId: 'PNT', jobTitle: 'Painter', joinedDate: '2018-12-20', currentClass: 'A', email: 'turki.zahrani@ebdaa.sa' },
  { id: 'E014', code: 'PNT-006', fullName: 'Majed Al-Qahtani', departmentId: 'PNT', jobTitle: 'Painter', joinedDate: '2021-02-28', currentClass: 'B', email: 'majed.qahtani@ebdaa.sa' },
  // Natural Wood (16 employees)
  { id: 'E015', code: 'NWD-001', fullName: 'Hamad Al-Subai', departmentId: 'NWD', jobTitle: 'Senior Carpenter', joinedDate: '2016-10-05', currentClass: 'A', email: 'hamad.subai@ebdaa.sa' },
  { id: 'E016', code: 'NWD-002', fullName: 'Waleed Al-Aqeel', departmentId: 'NWD', jobTitle: 'Carpenter', joinedDate: '2019-05-14', currentClass: 'A', email: 'waleed.aqeel@ebdaa.sa' },
  { id: 'E017', code: 'NWD-003', fullName: 'Abdulrahman Salem', departmentId: 'NWD', jobTitle: 'Carpenter', joinedDate: '2020-07-30', currentClass: 'B', email: 'abdulrahman.salem@ebdaa.sa' },
  { id: 'E018', code: 'NWD-004', fullName: 'Yasser Al-Habib', departmentId: 'NWD', jobTitle: 'Junior Carpenter', joinedDate: '2022-11-12', currentClass: 'C', email: 'yasser.habib@ebdaa.sa' },
  { id: 'E019', code: 'NWD-005', fullName: 'Nasser Al-Fahad', departmentId: 'NWD', jobTitle: 'Carpenter', joinedDate: '2018-04-18', currentClass: 'A', email: 'nasser.fahad@ebdaa.sa' },
  // Assembly (20 employees)
  { id: 'E020', code: 'ASM-001', fullName: 'Sami Al-Jadaan', departmentId: 'ASM', jobTitle: 'Senior Assembler', joinedDate: '2017-08-22', currentClass: 'A', email: 'sami.jadaan@ebdaa.sa' },
  { id: 'E021', code: 'ASM-002', fullName: 'Adel Al-Saqer', departmentId: 'ASM', jobTitle: 'Assembler', joinedDate: '2019-01-17', currentClass: 'B', email: 'adel.saqer@ebdaa.sa' },
  { id: 'E022', code: 'ASM-003', fullName: 'Hani Al-Zubair', departmentId: 'ASM', jobTitle: 'Assembler', joinedDate: '2020-06-09', currentClass: 'B', email: 'hani.zubair@ebdaa.sa' },
  { id: 'E023', code: 'ASM-004', fullName: 'Talal Al-Malki', departmentId: 'ASM', jobTitle: 'Junior Assembler', joinedDate: '2022-09-03', currentClass: 'C', email: 'talal.malki@ebdaa.sa' },
  { id: 'E024', code: 'ASM-005', fullName: 'Bassam Al-Khatiri', departmentId: 'ASM', jobTitle: 'Assembler', joinedDate: '2018-07-16', currentClass: 'A', email: 'bassam.khatiri@ebdaa.sa' },
  // Cutting (12 employees)
  { id: 'E025', code: 'CUT-001', fullName: 'Misfer Al-Shammari', departmentId: 'CUT', jobTitle: 'CNC Operator', joinedDate: '2018-02-27', currentClass: 'A', email: 'misfer.shammari@ebdaa.sa' },
  { id: 'E026', code: 'CUT-002', fullName: 'Raed Al-Turki', departmentId: 'CUT', jobTitle: 'Cutter', joinedDate: '2020-10-14', currentClass: 'B', email: 'raed.turki@ebdaa.sa' },
  { id: 'E027', code: 'CUT-003', fullName: 'Walid Al-Rifai', departmentId: 'CUT', jobTitle: 'Junior Cutter', joinedDate: '2023-03-05', currentClass: 'C', email: 'walid.rifai@ebdaa.sa' },
  { id: 'E028', code: 'CUT-004', fullName: 'Ziad Al-Rasheed', departmentId: 'CUT', jobTitle: 'CNC Operator', joinedDate: '2019-09-21', currentClass: 'A', email: 'ziad.rasheed@ebdaa.sa' },
  // Quality Control (10 employees)
  { id: 'E029', code: 'QC-001', fullName: 'Emad Al-Qahtani', departmentId: 'QC', jobTitle: 'QC Inspector', joinedDate: '2017-05-08', currentClass: 'A', email: 'emad.qahtani@ebdaa.sa' },
  { id: 'E030', code: 'QC-002', fullName: 'Fahad Mansour', departmentId: 'QC', jobTitle: 'QC Inspector', joinedDate: '2020-03-11', currentClass: 'B', email: 'fahad.mansour@ebdaa.sa' },
  { id: 'E031', code: 'QC-003', fullName: 'Khaled Al-Juhani', departmentId: 'QC', jobTitle: 'Junior QC Inspector', joinedDate: '2022-07-19', currentClass: 'B', email: 'khaled.juhani@ebdaa.sa' },
  // Logistics (14 employees)
  { id: 'E032', code: 'LOG-001', fullName: 'Tarek Al-Buraik', departmentId: 'LOG', jobTitle: 'Warehouse Supervisor', joinedDate: '2016-11-30', currentClass: 'A', email: 'tarek.buraik@ebdaa.sa' },
  { id: 'E033', code: 'LOG-002', fullName: 'Salem Al-Subaie', departmentId: 'LOG', jobTitle: 'Forklift Operator', joinedDate: '2019-04-07', currentClass: 'B', email: 'salem.subaie@ebdaa.sa' },
  { id: 'E034', code: 'LOG-003', fullName: 'Musaed Al-Omari', departmentId: 'LOG', jobTitle: 'Delivery Driver', joinedDate: '2021-08-24', currentClass: 'B', email: 'musaed.omari@ebdaa.sa' },
  { id: 'E035', code: 'LOG-004', fullName: 'Ghazi Al-Shamrani', departmentId: 'LOG', jobTitle: 'Inventory Clerk', joinedDate: '2022-01-17', currentClass: 'C', email: 'ghazi.shamrani@ebdaa.sa' },
  // Maintenance (8 employees)
  { id: 'E036', code: 'MNT-001', fullName: 'Abdulaziz Al-Osaimi', departmentId: 'MNT', jobTitle: 'Senior Technician', joinedDate: '2015-06-01', currentClass: 'A', email: 'abdulaziz.osaimi@ebdaa.sa' },
  { id: 'E037', code: 'MNT-002', fullName: 'Sultan Bahamdan', departmentId: 'MNT', jobTitle: 'Maintenance Technician', joinedDate: '2020-02-10', currentClass: 'B', email: 'sultan.bahamdan@ebdaa.sa' },
  { id: 'E038', code: 'MNT-003', fullName: 'Naif Al-Barqi', departmentId: 'MNT', jobTitle: 'Junior Technician', joinedDate: '2023-05-15', currentClass: 'C', email: 'naif.barqi@ebdaa.sa' },
  // Administration (26 employees)
  { id: 'E039', code: 'ADM-001', fullName: 'Reem Al-Subai', departmentId: 'ADM', jobTitle: 'HR Manager', joinedDate: '2015-01-15', currentClass: 'A', email: 'reem.subai@ebdaa.sa' },
  { id: 'E040', code: 'ADM-002', fullName: 'Maha Al-Najdi', departmentId: 'ADM', jobTitle: 'Accountant', joinedDate: '2018-05-20', currentClass: 'A', email: 'maha.najdi@ebdaa.sa' },
  { id: 'E041', code: 'ADM-003', fullName: 'Sara Al-Dawsari', departmentId: 'ADM', jobTitle: 'HR Coordinator', joinedDate: '2020-09-01', currentClass: 'B', email: 'sara.dawsari@ebdaa.sa' },
  { id: 'E042', code: 'ADM-004', fullName: 'Nora Al-Aqeel', departmentId: 'ADM', jobTitle: 'Receptionist', joinedDate: '2021-03-14', currentClass: 'B', email: 'nora.aqeel@ebdaa.sa' },
  { id: 'E043', code: 'ADM-005', fullName: 'Lama Al-Sulami', departmentId: 'ADM', jobTitle: 'Admin Assistant', joinedDate: '2022-06-08', currentClass: 'C', email: 'lama.sulami@ebdaa.sa' },
  // Additional employees to reach 50+
  { id: 'E044', code: 'UPH-009', fullName: 'Badr Al-Qahtani', departmentId: 'UPH', jobTitle: 'Upholsterer', joinedDate: '2020-04-12', currentClass: 'B', email: 'badr.qahtani@ebdaa.sa' },
  { id: 'E045', code: 'PNT-007', fullName: 'Salman Al-Ruwaili', departmentId: 'PNT', jobTitle: 'Painter', joinedDate: '2020-11-25', currentClass: 'B', email: 'salman.ruwaili@ebdaa.sa' },
  { id: 'E046', code: 'NWD-006', fullName: 'Tariq Al-Shehab', departmentId: 'NWD', jobTitle: 'Carpenter', joinedDate: '2021-07-03', currentClass: 'B', email: 'tariq.shehab@ebdaa.sa' },
  { id: 'E047', code: 'ASM-006', fullName: 'Mutab Al-Harbi', departmentId: 'ASM', jobTitle: 'Assembler', joinedDate: '2021-10-20', currentClass: 'B', email: 'mutab.harbi@ebdaa.sa' },
  { id: 'E048', code: 'LOG-005', fullName: 'Mansour Al-Utaibi', departmentId: 'LOG', jobTitle: 'Warehouse Clerk', joinedDate: '2022-03-09', currentClass: 'C', email: 'mansour.utaibi@ebdaa.sa' },
  { id: 'E049', code: 'QC-004', fullName: 'Mazen Al-Harith', departmentId: 'QC', jobTitle: 'QC Inspector', joinedDate: '2021-11-01', currentClass: 'B', email: 'mazen.harith@ebdaa.sa' },
  { id: 'E050', code: 'CUT-005', fullName: 'Muath Al-Barrak', departmentId: 'CUT', jobTitle: 'Cutter', joinedDate: '2021-06-15', currentClass: 'B', email: 'muath.barrak@ebdaa.sa' },
  { id: 'E051', code: 'ADM-006', fullName: 'Dina Al-Amri', departmentId: 'ADM', jobTitle: 'Payroll Specialist', joinedDate: '2019-02-18', currentClass: 'A', email: 'dina.amri@ebdaa.sa' },
  { id: 'E052', code: 'MNT-004', fullName: 'Hossam Al-Zubaidi', departmentId: 'MNT', jobTitle: 'Maintenance Technician', joinedDate: '2020-08-05', currentClass: 'B', email: 'hossam.zubaidi@ebdaa.sa' },
];
