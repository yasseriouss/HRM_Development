...
- Name: evaluation-flow.spec.ts >> End-to-End Evaluation Flow >> Employee login
- Location: tests\e2e\evaluation-flow.spec.ts:35:3
...
Call log:
  ...
  - waiting for locator('h1')
    9 × locator resolved to <h1 class="text-4xl font-headline font-bold text-foreground tracking-tight uppercase mb-2">HRM UNIFIED</h1>
