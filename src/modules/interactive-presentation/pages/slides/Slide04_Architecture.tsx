...
export default function Slide04_Architecture() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "var(--slide-bg)" }}>
      ...
      <div className={`absolute top-[8vh] ${isAr ? 'left-[6vw]' : 'right-[6vw]'}`} style={{ width: "46vw", display: "flex", flexDirection: "column", gap: "1.8vh", direction: isAr ? 'rtl' : 'ltr' }}>
        <div className="arch-anim-2" style={{ background: "rgba(212,150,10,0.08)", border: isAr ? "none" : "0.15vw solid rgba(212,150,10,0.35)", borderRight: isAr ? "0.15vw solid rgba(212,150,10,0.35)" : "none", borderLeft: isAr ? "none" : "0.15vw solid rgba(212,150,10,0.35)", borderRadius: "0.8vw", padding: "2.2vh 3vw", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
      ...
      <div className={`absolute bottom-[3vh] ${isAr ? 'left-[6vw]' : 'right-[6vw]'}`} style={{ textAlign: isAr ? 'left' : 'right' }}>
