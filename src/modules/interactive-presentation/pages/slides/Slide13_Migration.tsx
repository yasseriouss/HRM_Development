...
export default function Slide13_Migration() {
  ...
  return (
    <div className="relative w-screen h-screen overflow-hidden" style={{ background: "var(--slide-bg)" }}>
      ...
      <div className={`absolute top-[7vh] ${isAr ? 'right-[8vw]' : 'left-[8vw]'} mig-h`} style={{ textAlign: isAr ? 'right' : 'left' }}>
      ...
      <div className={`absolute top-[7vh] ${isAr ? 'left-[6vw]' : 'right-[6vw]'} mig-stats`} style={{ display: "flex", flexDirection: "column", gap: "2vh", direction: isAr ? 'rtl' : 'ltr' }}>
      ...
      <div className={`absolute top-[38vh] ${isAr ? 'right-[8vw]' : 'left-[8vw]'} ${isAr ? 'left-[6vw]' : 'right-[6vw]'} mig-steps`} style={{ direction: isAr ? 'rtl' : 'ltr' }}>
