    ...
    <section>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div className="bg-card border border-border rounded-xl p-6">
          <h3 className="font-semibold text-sm text-foreground mb-0.5">{t('dash_chart_completion_trend')}</h3>
          <p className="text-xs text-muted-foreground mb-4">{t('dash_chart_completion_trend_desc')}</p>
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          <h3 className="font-semibold text-sm text-foreground mb-0.5">{t('dash_chart_class_dist_time')}</h3>
          <p className="text-xs text-muted-foreground mb-4">{t('dash_chart_class_dist_time_desc')}</p>
          <ResponsiveContainer width="100%" height={220}>
      ...
      <div className="bg-card border border-border rounded-xl p-6">
        <h3 className="font-semibold text-sm text-foreground mb-0.5">{t('dash_chart_campaign_history')}</h3>
        <p className="text-xs text-muted-foreground mb-4">{t('dash_chart_campaign_history_desc')}</p>
              ...
              <div key={c.id} className="rounded-xl p-4 border" style={{ background: "rgba(255,255,255,0.02)", borderColor: "#2E3340" }}>
                <div className="flex flex-wrap items-start justify-between gap-2 mb-3">
                  ...
                  <div className="flex items-center gap-4 text-xs">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-muted-foreground">{t('dash_completed')}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-muted-foreground shrink-0">
                    {c.status === "Completed" ? t('dash_completed') : `${Math.round(timelinePct)}% ${t('dash_elapsed')}`}
                  </span>
                </div>
              </div>
            );
