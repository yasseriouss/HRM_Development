  ...
  return (
    <section>
      ...
      <div className="bg-card border border-border rounded-xl p-6 mb-6 overflow-x-auto">
        <h3 className="font-semibold text-sm text-foreground mb-0.5">{t('dash_chart_heatmap')}</h3>
        <p className="text-xs text-muted-foreground mb-4">{t('dash_chart_heatmap_desc')}</p>
        ...
        <div className="min-w-[680px]">
          ...
          <div className="mt-3 flex items-center gap-3 flex-wrap">
            <span className="text-xs text-muted-foreground">{t('dash_score_legend')}</span>
            {[
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-card border border-border rounded-xl p-6">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="font-semibold text-sm text-foreground">{t('dash_chart_top_skills')}</h3>
          </div>
          <p className="text-xs text-muted-foreground mb-4">{t('dash_chart_top_skills_desc')}</p>
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="font-semibold text-sm text-foreground">{t('dash_chart_bottom_skills')}</h3>
          </div>
          <p className="text-xs text-muted-foreground mb-4">{t('dash_chart_bottom_skills_desc')}</p>
          <div className="space-y-3">
